({
    ...
    handleDonate : function(component, event, helper){
        ...
        const action2 = component.get('c.getPaymentConfiguration');
        ...
        .then(resolve => {
            ...
            component.set('v.donor.Stripe_Customer_Id__c', responseObj.stripeCustomerReference);
            ...
            action2.setParams({
                ...
                shopperReferenceId : responseObj.shopperReference,
                donorString : JSON.stringify(component.get('v.donor')),
        ...
        .then(resolve => {
            ...
            const shopperReferenceId = action2.getParam('shopperReferenceId');
            ...
            if(resolve == null) {
                ...
                helper.showToast('error','Creation of payment session failed, please try it again. In case this error persist contact the info@cervenykriz.eu','Error','sticky');
                return; //when the payment session creation failed
            }
            
            component.set('v.paymentSessionConfiguration', resolve);
