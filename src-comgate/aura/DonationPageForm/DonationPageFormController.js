({
    doInit : function(component, event, helper){
        ...
        if(contactId) component.set('v.contact.Id', contactId);
    ...
    handleDonate : function(component, event, helper){
        ...
        const action1 = component.get('c.getPaymentReference');
        ...
        .then(resolve => {
            ...
            if(resolve == null) {
                ...
                helper.showToast('error','Creation of payment session failed, please try it again. In case this error persist contact the supporterservices@four-paws.org','Error','sticky');
